      ...
      <div className="relative w-full h-[360px] overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center">
          ...
          <div className="flex gap-2 mt-3 text-sm opacity-90">
            ...
            <span>/</span>
            <span className="text-white">Josh Erdman</span>
          </div>
        </div>
      </div>

      <section className="bg-[#efe1cc] py-16">
        <div className="max-w-[1450px] rounded-2xl mx-auto px-6">
          <div className="bg-[#e6cfab] p-6 shadow-md">
            ...
            >
              <h2 className="text-[22px]">JOSH ERDMAN</h2>
            </div>
            {/* Content */}
            ...
            {/* Button */}
             <div className="flex justify-between mt-6">
              ...
              >
                 <span className="mr-2">←</span> Amanda Schmieder{" "}
              ...
              <Link
               ...
               transition hover:brightness-110"
                style={{ background: "radial-gradient(#F4C688, #bf904f)" }}
              >
                Danny Newman <span className="ml-2">→</span>
              </Link>
            </div>
          </div>
        </div>
